...
const timeRanges = ["6 Months", "3 Months", "30 Days", "7 Days", "24 Hours"];
...
const chartData = [
  ...
  { month: "2022", primary: 29.5, secondary: 0 }, // Interpolated
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      <motion.div
        ...
        className="bg-gradient-to-br from-neutral-900 to-neutral-950 rounded-2xl p-8 border border-neutral-800"
      >
        {/* Header */}
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-semibold text-white">Bad Bot Traffic Rising</h2>
        ...
        {/* Hidden time range buttons - not relevant for yearly data */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className={`bg-neutral-800/50 rounded-xl p-6 border ${
                index === 0
                  ? "border-blue-500/30 bg-blue-500/5"
                  : "border-neutral-700"
              }`}
            >
              <p className={`text-sm mb-2 ${index === 0 ? "text-blue-400" : "text-neutral-400"}`}>
                {stat.label}
              </p>

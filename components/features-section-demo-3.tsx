  ...
  return (
    <div className={cn(`relative`, className)}>
      <GlowingEffect
        ...
        inactiveZone={0.01}
      />
      <div className="relative p-4 sm:p-8 overflow-hidden h-full">
        {children}
      </div>
    </div>
  );
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      ...
      <div className="absolute bottom-0 z-40 inset-x-0 h-40 bg-gradient-to-t from-white/80 dark:from-black via-white/40 dark:via-black to-transparent w-full pointer-events-none" />
      <div className="absolute top-0 z-40 inset-x-0 h-40 bg-gradient-to-b from-white/80 dark:from-black via-transparent to-transparent w-full pointer-events-none" />
    </div>
  );
};
...
export const SkeletonTwo = () => {
  ...
  // Use fixed rotation values to avoid hydration mismatch
  const rotations = [-2.5, 3.2, -5.8, 7.1, -4.3];
  ...
  return (
    <div className="relative flex flex-col items-start p-8 gap-10 h-full overflow-hidden">
      ...
      <div className="absolute left-0 z-[100] inset-y-0 w-20 bg-gradient-to-r from-white/90 dark:from-black to-transparent  h-full pointer-events-none" />
      <div className="absolute right-0 z-[100] inset-y-0 w-20 bg-gradient-to-l from-white/90 dark:from-black  to-transparent h-full pointer-events-none" />
    </div>
  );
};
